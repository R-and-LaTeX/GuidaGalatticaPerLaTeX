...
ciò è necessario marcare con \verb!\label{...}! a cui si vuole fare 
riferimento. Tra parentesi graffe un identificativo univoco all'interno del 
documento. Quando ci si riferisce ad esso, si deve utilizzare \verb!\ref{...}!
, specificando tra graffe lo stesso identificativo. È possibile anche fare 
riferimento alla pagina in cui si trova l'oggetto marcato con \verb!label! 
utilizzando \verb!\pageref{...}! (e lo stesso identificativo).
...
succede nei siti Web per capirci). 
...
\verb!\newcommand{\mail}[1]{\href{mailto:#1}{\texttt{#1}}}! (per il momento 
fidatevi, spiegheremo in seguito come creare i propri comandi). L'utilizzo è 
molto semplice, infatti nel documento è sufficiente dare il comando 
\verb!\email{...}! specificando l'indirizzo di posta elettronica voluto.
